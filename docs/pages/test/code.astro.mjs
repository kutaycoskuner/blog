...
const $$Code = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "LayoutBlank", $$LayoutBlank, { "data-astro-cid-lz5gqx5u": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="shiki-code" data-astro-cid-lz5gqx5u>${unescapeHTML(highlightedCode)}</div> ` })} `;
}, "C:/Users/kutay/OneDrive/Documents/GitHub/blog/src/pages/test/code.astro", void 0);

const $$file = "C:/Users/kutay/OneDrive/Documents/GitHub/blog/src/pages/test/code.astro";
const $$url = "/blog/test/code";
