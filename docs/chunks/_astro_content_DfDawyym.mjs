import { o as objectType, i as dateType, j as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, k as escape, G as GetEntryDeprecationError, l as renderUniqueStylesheet, n as renderScriptElement, p as createHeadAndContent, a as renderComponent } from './astro/server_DJz8TuEr.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CFyWdg7e.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/blog/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://kutaycoskuner.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DmabLdSX.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_E5OkeOKS.mjs');
...
export { DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, getEntry as a, getEntryBySlug as b, DEFAULT_HASH_PROPS as c, getCollection as g, isRemotePath as i, joinPaths as j };
